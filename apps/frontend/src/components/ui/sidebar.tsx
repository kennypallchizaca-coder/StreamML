      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Menú móvil de StreamML.</SheetDescription>
          </SheetHeader>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          width: state === "collapsed" && collapsible === "icon"
            ? (variant === "floating" || variant === "inset" ? "calc(var(--sidebar-width-icon) + 1rem)" : "var(--sidebar-width-icon)")
            : "var(--sidebar-width)"
        }}
        className={cn(
      ...
      <div
        ...
        style={{
          width: state === "collapsed" && collapsible === "icon"
            ? (variant === "floating" || variant === "inset" ? "calc(var(--sidebar-width-icon) + 1rem + 2px)" : "var(--sidebar-width-icon)")
            : "var(--sidebar-width)"
        }}
        className={cn(
