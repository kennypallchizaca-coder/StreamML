...
from src.predictive_features import FEATURE_COLUMNS, build_feature_row
...
def build_predictive_features(
    ...
    """
    Construye las variables predictivas a partir de una ventana historica offline (120s).
