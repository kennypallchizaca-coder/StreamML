...
from src.predictive_features import FEATURE_COLUMNS, frame_in_contract_order, load_feature_contract
...
def train_predictive_release(root: Path, config: dict) -> dict:
    ...
    contract_path = root / "config" / "predictive_feature_contract.json"
    ...
    release_dir = root / config["paths"].get("release_dir", "models/release/predictive")
    ...
    manifest = {
        ...
        "model_path": "models/release/predictive/model.joblib",
